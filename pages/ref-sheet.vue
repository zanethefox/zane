...
<template>
  <div>
    <div class="bg-gradient-to-b from-white via-white to-pink-100 py-28" />
    <div class="bg-gradient-to-t from-pink-100 from-0% via-pink-200 via- to-pink-100">
      <div class="mx-auto max-w-7xl px-6 lg:px-8 pt-0">
          ...
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="flex flex-col gap-8">
              ...
              <div class="lg:px-2">
                <div class="relative flex w-full flex-col rounded-2xl bg-white/50 outline outline-black/5 dark:bg-neutral-950 p-7 gap-6">
                  <div class="flex flex-col gap-2 text-start">
                    <p class="text-sm text-neutral-500">Attachments</p>
                  </div>
            ...
            <div class="lg:col-span-2 flex flex-col gap-8">
              <div
                class="relative flex w-full flex-col rounded-2xl bg-white/50 outline outline-black/5 dark:bg-neutral-950 p-8 gap-6 backdrop-blur-md">
                <NuxtImg
                  src="/images/ref-sheet/zane-3-views.png"
                  placeholder
                  placeholder-class="bg-neutral-200 animate-pulse rounded-lg"
                  loading="lazy"
                  class="object-cover w-full h-auto aspect-[1907/1271]" />
              </div>
                ...
                <div class="lg:col-span-5 flex flex-col gap-8">
                  <div class="flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                      <div v-for="(item, index) in zaneInventory" :key="item.label + '-' + index" class="flex flex-col gap-1">
                        <div class="rounded-2xl bg-gradient-to-b from-white/30 to-white/40 outline outline-black/5">
                          <NuxtImg
                            ...
                            :alt="item.label"
                            placeholder
                            placeholder-class="bg-neutral-200 animate-pulse rounded-lg p-1"
                            loading="lazy"
                            class="object-contain aspect-square w-full h-auto" />
                        </div>
                  ...
                  <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="col-span-1">
                      <div v-for="(item, index) in zaneAccs" :key="item.label + '-' + index" class="flex flex-col gap-1">
                        <div class="flex rounded-2xl bg-gradient-to-b from-white/30 to-white/40 outline outline-black/5">
                          <NuxtImg
                            :key="index"
    ...
    <div class="bg-gradient-to-t from-white to-pink-100 py-12" />
  </div>
</template>
